	...
	<div class="row flex-column-reverse flex-md-row">
		<div class="col-12 col-md-5">
			...
			<div class="d-block d-md-none d-lg-block">
				<a href="{{ url('/posts') }}" class="btn btn-dark btn-shp shadow">Tutorial</a>
			</div>
		</div>
		<div class="col-12 col-lg-7">
			<img src="{{ asset('/assets/img/img_hero_section.png') }}" class="img-fluid">
		</div>
	</div>
...
<section class="category py-5">
	<div class="container">
		...
		<div class="text-end py-3">
			<p><a href="{{ url('/all-categories') }}" class="text-decoration-none text-muted h5"> More Category . . .</a></p>
		</div>
	</div>
</section>
...
<div class="container">
		...
		@endforeach
		<div class="text-end py-3">
			<p><a href="{{ url('/posts') }}" class="text-decoration-none text-muted h5"> More posts . . .</a></p>
		</div>
	</div>
</section>
